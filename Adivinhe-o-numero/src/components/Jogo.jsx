...
function verificarPalpite() {
    ...
    if (numero === numeroSecreto) {
        setMensagem(`Parabéns! Você acertou o número secreto ${numeroSecreto} em ${tentativas + 1} tentativas.`)
...
function novoJogo() {
    const novoNumero = Math.floor(Math.random() * (maximo - minimo + 1)) + minimo
...
const larguraFaixa = ((maior - menor) / (maximo - minimo)) * 100
const inicioFaixa = ((menor - minimo) / (maximo - minimo)) * 100
    ...
    <div className="jogo">
        <div className="cabecalho">
            <div>
                ...
                <p>Pensei em um número entre {minimo} e {maximo}. Tente adivinhar!</p>
            </div>
        ...
        <div className="faixa-container">
            <div className="faixa-titulo"></div>
            ...
            <button className="botao-novo" onClick={novoJogo}>
                Novo Jogo
            </button>
        </div>
    )
